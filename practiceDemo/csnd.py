...
def createGui(msg=''):
    ...
    frm_top_label = tk.Label(root, compound='top', image=tk_image, text="验证码图片", fg="blue", bg="brown",
    ...
    frm_bottom_btn_0 = tk.Button(frm_bottom, text="下   载", relief=RIDGE, bd=4, width=10, font=('Tempus Sans ITC', 12),
                                 command=lambda: downloadSource(frm_bottom_entry_var_0, frm_bottom_entry_var_1,
                                                                frm_top_label, frm_foot_label))
